...
function loadCloudSettings() {
  ...
  if (accountHint) {
    ...
    accountHint.textContent = user ? `Usuário: ${user.email || user.name} • Workspace: ${user.workspace_id || profile.workspaceId || '-'}` : 'Faça login para liberar sincronização e backup.';
  }
