...
function openAddStockModal() {
  ...
  const stockBrandEl = document.getElementById('stockBrand');
  if (stockBrandEl) stockBrandEl.value = '';
  const stockExpiryDateEl = document.getElementById('stockExpiryDate');
  if (stockExpiryDateEl) stockExpiryDateEl.value = '';
...
function openEditStockModal(id) {
  ...
  const stockBrandEl = document.getElementById('stockBrand');
  if (stockBrandEl) stockBrandEl.value = item.brand || '';
  const stockExpiryDateEl = document.getElementById('stockExpiryDate');
  if (stockExpiryDateEl) stockExpiryDateEl.value = item.expiryDate || '';
  const stockNoteEl = document.getElementById('stockNote');
  if (stockNoteEl) stockNoteEl.value = item.note || '';
