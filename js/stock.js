      ...
      <div class="premium-stock-top">
        ...
        <div class="premium-stock-side">
          <div class="premium-qty-control" aria-label="Controle de quantidade">
            <button type="button" class="qty-mini-btn premium-qty-btn small-step" onclick="changeStockQty('${item.id}', -5)" aria-label="Diminuir 5">−5</button>
            ...
            <button type="button" class="qty-mini-btn premium-qty-btn small-step" onclick="changeStockQty('${item.id}', 5)" aria-label="Aumentar 5">+5</button>
          </div>
